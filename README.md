...
Platform engineer based in central Florida. I work at the intersection of architecture and implementation — the kind of problems where someone hands you a half-formed idea and expects a working system on the other side.

Day job: long-term embedded senior engineer at North Point Ministries, working primarily in the Rock RMS ecosystem across platform architecture, data engineering, API development, and plugin development.

Currently building seriously in the AI space — MCP servers, Claude Code tooling, AI-augmented development workflows.

---

**Stack:** C# · .NET · Python · FastAPI · TypeScript · AWS · MS SQL · PostgreSQL
...
📬 ken@kenmulford.com · [linkedin.com/in/kmulford](https://linkedin.com/in/kmulford)
